...
// SED1356_LCD_MISC
#define SED1356_LCD_MISC_DITH			BIT1			// 1 = Dither Disable, Passive Panel Only
#define SED1356_LCD_MISC_DUAL			BIT0			// 1 = Dual Panel Disable, Passive Panel Only

// SED1356_REG_CRT_OUT_CTL
#define SED1356_CRT_OUT_CHROM			BIT5			// 1 = TV Chrominance Filter Enable
#define SED1356_CRT_OUT_LUM				BIT4			// 1 = TV Luminance Filter Enable
#define SED1356_CRT_OUT_DAC_LVL			BIT3			// 1 = 4.6ma IREF, 0 = 9.2 IREF
#define SED1356_CRT_OUT_SVIDEO			BIT1			// 1 = S-Video Output, 0 = Composite Video Output
#define SED1356_CRT_OUT_PAL				BIT0			// 1 = PAL Format Output, 0 = NTSC Format Output
...
#define SED1356_VER_NONDISP				0x80			// vertical retrace status 1 = in retrace
