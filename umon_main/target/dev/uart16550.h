...
#define UART_USR_REG	0x7c		 // DAN - 
#define UART_SRR_REG    0x88    	 // DAN - Software Reset Register.

/* uart Software Reset register (SRR) */
#define UART_SRR_UR		(0x00000001) // DAN - UART_SRR_REG[0] - UART Reset
/* uart Status register (USR) */
#define UART_USR_BUSY					(0x00000001)
#define UART_USR_TFNF					(0x00000002)
#define UART_USR_TFE					(0x00000004)
#define UART_USR_RFNE					(0x00000008)
#define UART_USR_RFF					(0x00000010)
