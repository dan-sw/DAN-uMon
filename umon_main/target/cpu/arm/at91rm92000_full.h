...
#define ST_CR 		// Control Register
#define ST_PIMR 	// Period Interval Mode Register
#define ST_WDMR 	// Watchdog Mode Register
#define ST_RTMR 	// Real-time Mode Register
#define ST_SR 		// Status Register
#define ST_IER 		// Interrupt Enable Register
#define ST_IDR 		// Interrupt Disable Register
#define ST_IMR 		// Interrupt Mask Register
#define ST_RTAR 	// Real-time Alarm Register
#define ST_CRTR 	// Current Real-time Register

#define RTC_CR 		// Control Register
#define RTC_MR 		// Mode Register
#define RTC_TIMR 	// Time Register
#define RTC_CALR 	// Calendar Register
#define RTC_TIMALR 	// Time Alarm Register
#define RTC_CALALR 	// Calendar Alarm Register
#define RTC_SR 		// Status Register
#define RTC_SCCR 	// Status Clear Command Register
#define RTC_IER 	// Interrupt Enable Register
#define RTC_IDR 	// Interrupt Disable Register
#define RTC_IMR 	// Interrupt Mask Register
#define RTC_VER 	// Valid Entry Register

#define MC_RCR 		// MC Remap Control Register
#define MC_ASR 		// MC Abort Status Register
#define MC_AASR 	// MC Abort Address Status Register
#define MC_PUIA 	// MC Protection Unit Area
#define MC_PUP 		// MC Protection Unit Peripherals
#define MC_PUER 	// MC Protection Unit Enable Register
