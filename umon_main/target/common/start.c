...
// KS:  Do not perform any manipulations with the BSS
//		WE are using our standard C-runtime entry to Umon, so it is clean at a start time
void
umonBssInit(void)
{
#if 0
...
// not compiled under Windows simulation
void
__eabi(void)
{
}
